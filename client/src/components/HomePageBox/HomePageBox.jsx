...
const HomePageBox = ({ homeData, loading }) => {
  ...
  useEffect(() => {
    ...
    var countUnknown = homeData.length - (countOnline + countOffline);
  ...
  return (
    <>
      <div className="h-[21vh] overflow-auto grid grid-flow-col items-center gap-2 sm:grid-cols-4 hideScrollBar px-6">
        {loading ? <div className=" bg-white dark:bg-slate-900 w-[90vw] sm:w-full h-[13.5vh] rounded-xl pr-4 pt-2 flex-row-reverse flex justify-between items-center shadow-lg shadow-black">
          ...
          <div className="flex ml-4 w-full">
            ...
            <div className="flex flex-col w-full ml-4">
              ...
              <h1 className="w-full text-xl font-semibold text-blue-700">{homeData.length < 10 ? "0" + homeData.length : homeData.length}</h1>
            </div>
          </div>
        </div> : <Skeleton
          ...
          height={100}
        />}
        {loading ? <div className=" bg-white dark:bg-slate-900 sm:w-full w-[90vw] h-[13.5vh] rounded-xl pr-4 pt-2 flex-row-reverse flex justify-between items-center shadow-lg shadow-black">
