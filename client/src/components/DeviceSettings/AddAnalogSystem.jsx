      ...
      <div className=" w-full rounded-md flex flex-col justify-around p-4 h-[100%]">
                      ...
                      <div className=" flex flex-col justify-between">
                          ...
                          <div className=' flex gap-4'>
                              <input type="text" placeholder='0' name="" id="" className="w-[50%] h-8 rounded-full px-4 outline-none border-[1.5px] border-black dark:bg-slate-600" />
                              <input type="text" placeholder='100' name="" id="" className="w-[50%] h-8 rounded-full px-4 outline-none border-[1.5px] border-black dark:bg-slate-600" />
                          </div>
                      </div>
                      <div className=" flex flex-col justify-between">
                          <h1 className=' font-semibold'>Alert Limits (High-Low)</h1>
                          <div className=' flex gap-4'>
                              <input type="text" placeholder='High' name="" id="" className="w-[50%] h-8 rounded-full px-4 outline-none border-[1.5px] border-black dark:bg-slate-600" />
                              <input type="text" placeholder='Low' name="" id="" className="w-[50%] h-8 rounded-full px-4 outline-none border-[1.5px] border-black dark:bg-slate-600" />
                          </div>
                      </div>
                      <div className=" flex flex-col justify-between">
...
export default AddAnalogSystem
