...
const LivePage = () => {
  ...
  return (
    <div className=' pt-[10vh] bg-slate-100 h-full w-screen pb-[5rem] dark:bg-slate-900 overflow-x-hidden px-2 min-h-screen'>
      ...
      <div className='border bg-white w-full p-4 rounded-xl shadow-xl shadow-black flex flex-col gap-4 items-start justify-start sm:flex-row sm:items-center sm:justify-around'>
